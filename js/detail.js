function Enlarge(ele) {
    ...
    // 1. show 盒子
    this.show = this.ele.querySelector('.yuantu')
    // 2. mask 盒子
    ...
    // 7. 获取列表盒子
    this.list = this.ele.querySelector('.small')
...
/*
  ...
  问题: 请求哪一条商品的信息 ?
    ...
    + 点击商品据 i的时候, 把商品 id 存储在 cookie 里面
    + 在详情页拿到商品 id, 根d 去请求这一条商品
...
//     <div class="small">
//         <span  class="active">
//             <img src="${ info.goods_small_logo } " show="${ info.goods_small_logo }" ${ info.goods_small_logo }">
//         </span>
//     </div>
// </div>
//     `
...
<div class="br2">
    <div class="jg">
        <b>价&nbsp;&nbsp;格</b>&nbsp;&nbsp;<i style="color: red;">抢购价</i><span class="sp1" style="color: red;">￥${ info.goods_price }</span><s >￥ 5299.00</s><p class="pp">定金 ￥100.00</p>
    </div>
    <div class="br3">
        <em>促&nbsp;&nbsp;销</em>
...
<div class="btn">
    <div class="btn1">
      ...
      <div class="cart">
                    <div class="cart1">
                        <button class="jian subNum">-</button>
                        <input class="cartNum" type="text" value="1">
                        <button class="jia addNum">+</button>
                    </div>
                    <div class="cart2">
                        <button class="c addCart">
    ...
    // 3. 商品参数渲染
    // $('.canshu').html(info.goods_introduce)
  }

  // 4. 加入购物车的操作
  $('.br').on('click', '.addCart', function () {
