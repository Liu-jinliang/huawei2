...
$(function () {
  ...
  async function getGoodsList() {
    ...
    `<li>
        <a>
            <img  data-id="${ item.goods_id }" src="${ item.goods_big_logo }" alt="">
            <p>${ item.goods_name }</p>
            <div class="erp">
  ...
  // 4. 一级分类的点击事件
  // 4-1. 事件委托的形式进行事件绑定
  $('.fenlei1').on('click', 'span', function () {
    console.log(this)
    // 4-2. 操作类名
    ...
    $('.fenlei2>.fl1').html('<span data-type="all" class="active">全部</span>')
